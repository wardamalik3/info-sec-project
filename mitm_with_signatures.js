...
const aliceECDH = crypto.generateKeyPairSync("ec", {
  namedCurve: "prime256v1",
});
const aliceECDSA = crypto.generateKeyPairSync("ec", {
  namedCurve: "prime256v1",
});
console.log("logs from mitm_with_signatures.js:");
...
const malloryECDH = crypto.generateKeyPairSync("ec", {
  namedCurve: "prime256v1",
});
const malloryECDSA = crypto.generateKeyPairSync("ec", {
  namedCurve: "prime256v1",
});
...
const alicePublicKeyPEM = aliceECDH.publicKey.export({
  type: "spki",
  format: "pem",
});
...
const malloryPublicKeyPEM = malloryECDH.publicKey.export({
  type: "spki",
  format: "pem",
});
console.log(
  "\nMallory's public key:",
  malloryPublicKeyPEM.substring(0, 50) + "..."
);
...
// ============================================
console.log(
  "🔍 STEP 4: Option 1 - Mallory sends her key with Alice's signature\n"
);
...
// ============================================
console.log(
  "🔍 STEP 5: Option 2 - Mallory signs her key with her own signing key\n"
);
...
if (!isValid2) {
  console.log("\n🛡️  MITM ATTACK BLOCKED!");
  console.log(
    "Reason: Signature was created with Mallory's key, not Alice's key"
  );
...
console.log(
  "🛡️  Digital signatures provide AUTHENTICATION and prevent MITM!\n"
);
